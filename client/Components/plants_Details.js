      ...
      <div class="container px-5 py-24 mx-auto">
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
          <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
            ...
            <h1 class="text-gray-900 text-3xl title-font font-medium mb-4">Sansevieria</h1>
            <div class="flex mb-4">
              <a class="flex-grow text-emerald-500 border-b-2 border-emerald-500 py-2 text-lg px-1">Description</a>
            ...
            <div class="flex">
              ...
              <button class="flex ml-auto text-white bg-emerald-300 border-0 py-2 px-6 focus:outline-none hover:bg-emerald-600 rounded">Add to Cart</button>
          ...
          <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://bloomscape.com/wp-content/uploads/2020/08/bloomscape_sansevieria_indigo-e1633460770478.jpg?ver=279443"/>
        </div>
      </div>
    </section>
    </div>
