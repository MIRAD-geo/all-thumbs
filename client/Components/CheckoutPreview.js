    ...
    <div class="flex shadow-md my-10">
      <div class="w-3/4 bg-white px-10 py-10">
        ...
        <div class="flex mt-10 mb-5">
          ...
          <h3 class="font-semibold text-center text-stone-600 text-xs uppercase w-1/5 text-center">Quantity</h3>
          <h3 class="font-semibold text-center text-stone-600  text-xs uppercase w-1/5 text-center">Price</h3>
          <h3 class="font-semibold text-center text-stone-600  text-xs uppercase w-1/5 text-center">Total</h3>
        </div>
